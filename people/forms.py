...
class AddPostForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cat'].empty_label = '-Wybierz-'
    ...
    def clean_title(self):
        ...
        if len(title) > 200:
            raise ValidationError('Za długie imię. Max. 200 symbolów.')
        return title
...
class RegisterUserForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Powtórz hasło', widget=forms.PasswordInput(attrs={'class': 'form-input'}))
